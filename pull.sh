#40 * * * * pull.sh, tag=拉取
ql repo https://gitee.com/xiecoll/radish-script.git "lb_|Chinaunicom" #饿了么，美团，联通
ql repo https://gitee.com/soy-tool/app-script.git 'app_yhxq|wytk|app_dwsj|app_kyin' #源火,闪电世界，快音
ql repo https://github.com/leafxcy/JavaScript.git 'ks.js|ksjsb|txstock' #快手，自选股
ql repo https://github.com/yml2213/javascript.git 'sytt|lmz|xlh' 'invalid' #十堰，狸猫,骁龙会
...
ql repo https://github.com/passerby-b/didi_fruit.git 'dd_fruit' #滴滴果园
